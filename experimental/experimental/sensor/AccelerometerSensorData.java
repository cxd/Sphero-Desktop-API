...
//        int a = (data[1] | (data[0] << 8));
//        int y = (data[3] | (data[2] << 8));
//        int z = (data[5] | (data[4] << 8));
//
//        AccelerometerSensorData as = new AccelerometerSensorData( a, y, z );
//        SensorData.Axis3Sensor raw = as.getAxis3Sensor();
//        System.err.println( "a=" + raw.getA() + ", y=" + raw.getY() + ", z=" + raw.getZ() );
    ...
    {
        return this.accelerationRaw;//new Vector3D( this.accelerationRaw.a, this.accelerationRaw.y, this.accelerationRaw.z );
    }
